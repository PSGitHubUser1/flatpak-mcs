...
> - Original version of `auto-mcs` is [here](https://github.com/macarooni-man/auto-mcs).
 ...
 ![inqSerdiagram](https://files.catbox.moe/mltfay.png)
 ...
 - To get started, download the latest version of `AutoMCS.flatpak` from **Releases** page.
 
 - Install a flatpak named **Warehouse**.
 
 - Open `AutoMCS.flatpak` and it will redirect you to **Warehouse**, if it doesn't select Warehouse.
 
 - Install as User-based, not System-based.
